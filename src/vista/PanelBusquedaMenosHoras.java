...
public class PanelBusquedaMenosHoras extends JPanel implements ActionListener {
	...
	public void iniciarComponentes() {
		...
		lblHorasVueloTotal.setForeground(Color.WHITE);
		...
		lblTotalEscala.setForeground(SystemColor.windowText);
		...
		lblRespuestaTotalViaje.setForeground(Color.WHITE);
